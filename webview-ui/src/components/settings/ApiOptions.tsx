...
const ApiOptions = ({
	...
	const onProviderChange = useCallback(
		(value: ProviderName) => {
			...
			switch (value) {
				...
				case "litellm":
					...
					break
				case "flow":
					if (!apiConfiguration.flowModelId) {
						setApiConfigurationField("flowModelId", flowDefaultModelId)
					}
					break
			}
		...
		[setApiConfigurationField, apiConfiguration.openRouterModelId, apiConfiguration.glamaModelId, apiConfiguration.unboundModelId, apiConfiguration.requestyModelId, apiConfiguration.litellmModelId, apiConfiguration.flowModelId],
	)
